class ApiLinks {
  static String employeeListApiLink =
      "https://hrms.szamantech.com/api/employee-api";
  static String departmentListApiLink =
      "https://hrms.szamantech.com/api/department-api";
  ...
  static String addAttendanceLink =
