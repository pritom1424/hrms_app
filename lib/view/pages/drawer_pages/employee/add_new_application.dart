...
import 'package:hrms_app/view/pages/drawer_pages/employee/employee_table.dart';
        ...
        children: [
          Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    'Shift Date: ${DateFormat.yMd().format(_selectedShiftDate)}',
                    style: TextStyle(fontSize: mediumLabelFontSize),
                  ),
          ...
          Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    'Joining Date: ${DateFormat.yMd().format(_selectedJoiningDate)}',
                    style: TextStyle(fontSize: mediumLabelFontSize),
                  ),
                  const SizedBox(width: 20),
                  TextButton(
          ...
          Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    'Confirmation Date: ${DateFormat.yMd().format(_selectedConfirmationDate)}',
                    style: TextStyle(fontSize: mediumLabelFontSize),
                  ),
                  const SizedBox(width: 20),
                  TextButton(
