...
class _MyDataTableState extends State<MyDataTable> {
  ...
  MaterialStateColor getRandomColor() {
    ...
    return MaterialStateColor.resolveWith((states) => Color.fromRGBO(r, g, b, 1.0));
  }
      ...
      body: RawScrollbar(
        ...
        child: SingleChildScrollView(
          ...
          child: DataTable(
            ...
            dividerThickness: 3,
            headingRowColor: MaterialStateColor.resolveWith((states) => Colors.blue.shade400),
            dataRowColor:  MaterialStateColor.resolveWith((states) => Colors.black26),
            sortAscending: true,
            columns: const [
              DataColumn(
                label: Text('ID'),
